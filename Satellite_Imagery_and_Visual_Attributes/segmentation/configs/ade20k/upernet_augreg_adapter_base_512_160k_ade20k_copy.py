...
_base_ = [
    #'../_base_/models/upernet_r50.py', '../_base_/datasets/loveda_copy.py', #train_loveDA_my
...
#pretrained = 'pretrained/upernet_augreg_adapter_base_512_160k_ade20k.pth.tar'
pretrained = False
model = dict(
    ...
    backbone=dict(
        ...
        window_size=[None] * 12),
    #decode_head=dict(num_classes=7, in_channels=[768, 768, 768, 768]),
    #auxiliary_head=dict(num_classes=7, in_channels=768),
    decode_head=dict(num_classes=2, in_channels=[768, 768, 768, 768]),
